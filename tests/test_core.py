...
class TestHashCalculation:
    ...
    def test_calculate_hash_consistent(self):
        ...
        text = "Hello, World!"
        hash1 = core.calculate_hash(text)
        hash2 = core.calculate_hash(text)
        assert hash1 == hash2
    
    def test_calculate_hash_different(self):
        """Different text should produce different hashes"""
        hash1 = core.calculate_hash("Text 1")
        hash2 = core.calculate_hash("Text 2")
        assert hash1 != hash2
    ...
    def test_calculate_hash_sha256(self):
        ...
        result = core.calculate_hash(text)
...
class TestDiffGeneration:
    ...
    def test_generate_diff_no_change(self):
        ...
        text = "Same text"
        diff = core.generate_diff(text, text)
        assert diff == ""
    ...
    def test_generate_diff_with_change(self):
        ...
        old = "Line 1\nLine 2\nLine 3"
        new = "Line 1\nModified Line 2\nLine 3"
        diff = core.generate_diff(old, new)
...
class TestRobotsTxt:
    ...
    def test_robots_txt_allowed(self, mock_parser):
        ...
        result = core.check_robots_txt("https://example.com/page")
    ...
    def test_robots_txt_disallowed(self, mock_parser):
        ...
        result = core.check_robots_txt("https://example.com/admin")
...
class TestDomainComparison:
    ...
    def test_subdomain_handling(self):
        ...
        result = core.is_same_domain(url1, url2)
